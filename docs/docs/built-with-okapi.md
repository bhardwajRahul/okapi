...
### [Certio](https://github.com/jkaninda/certio)

Self-signed PKI and TLS certificate management in a single binary. Run an internal certificate authority from a dashboard, REST API, CLI, and ACME server, with issuance, renewal, revocation, and trust distribution built in.

- **Use case:** Internal PKI and TLS certificates
- **Repository:** [github.com/jkaninda/certio](https://github.com/jkaninda/certio)
...
2. Edit [`docs/docs/built-with-okapi.md`](https://github.com/jkaninda/okapi/blob/main/docs/docs/built-with-okapi.md) and add your project following the format above (name, one-line description, use case, repository link).
